...
FactoryBot.create_list(:mood, 5, patient: patient1)
...
puts "Patient1 created with appointments, exercise_entries, journal_entries, medication_entries, mindfulness_activities, moods, nutrition_entries, sleep_entries, social_interactions, and patterns"
...
FactoryBot.create_list(:mood, 5, patient: patient2)
...
puts "Patient2 created with appointments, exercise_entries, journal_entries, medication_entries, mindfulness_activities, moods, nutrition_entries, sleep_entries, social_interactions, and patterns"
...
FactoryBot.create_list(:mood, 5, patient: patient3)
...
puts "Patient3 created with appointments, exercise_entries, journal_entries, medication_entries, mindfulness_activities, moods, nutrition_entries, sleep_entries, social_interactions, and patterns"
...
FactoryBot.create_list(:mood, 5, patient: patient4)
...
puts "Patient4 created with appointments, exercise_entries, journal_entries, medication_entries, mindfulness_activities, moods, nutrition_entries, sleep_entries, social_interactions, and patterns"
...
FactoryBot.create_list(:mood, 5, patient: patient5)
...
puts "Patient5 created with appointments, exercise_entries, journal_entries, medication_entries, mindfulness_activities, moods, nutrition_entries, sleep_entries, social_interactions, and patterns"
...
FactoryBot.create_list(:mood, 5, patient: patient6)
...
puts "Patient6 created with appointments, exercise_entries, journal_entries, medication_entries, mindfulness_activities, moods, nutrition_entries, sleep_entries, social_interactions, and patterns"
...
FactoryBot.create_list(:mood, 5, patient: patient7)
...
puts "Patient7 created with appointments, exercise_entries, journal_entries, medication_entries, mindfulness_activities, moods, nutrition_entries, sleep_entries, social_interactions, and patterns"
...
FactoryBot.create_list(:mood, 5, patient: patient8)
...
puts "Patient8 created with appointments, exercise_entries, journal_entries, medication_entries, mindfulness_activities, moods, nutrition_entries, sleep_entries, social_interactions, and patterns"
...
FactoryBot.create_list(:mood, 5, patient: patient9)
...
puts "Patient9 created with appointments, exercise_entries, journal_entries, medication_entries, mindfulness_activities, moods, nutrition_entries, sleep_entries, social_interactions, and patterns"
...
FactoryBot.create_list(:mood, 5, patient: patient10)
...
puts "Patient10 created with appointments, exercise_entries, journal_entries, medication_entries, mindfulness_activities, moods, nutrition_entries, sleep_entries, social_interactions, and patterns"
